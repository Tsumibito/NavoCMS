...
Дата планирования: 2026-09-05. Статус: Sprint 8.1 реализован и возвращён на исправления после
независимой приёмки PR #53; merge/deploy и критерий 8 остаются открытыми.
Следующее задание: [corrective handoff](../development/SPRINT_8_1_CORRECTIVE_HANDOFF.md).
