...
| ADR | Status | Decision |
|---|---|---|
| [0001](0001-agent-first-product-boundary.md) | Proposed | Agent-first product with optional focused UI |
| [0002](0002-typescript-kernel-language-neutral-plugins.md) | Proposed | TypeScript kernel and language-neutral service plugins |
| [0003](0003-capability-plugin-model.md) | Proposed | Capability-based plugin graph around a trusted kernel |
| [0004](0004-markdown-content-model.md) | Proposed | Markdown source with typed directives and immutable revisions |
| [0005](0005-multitenancy-from-foundation.md) | Proposed | Tenant and site isolation from the first implementation |
| [0006](0006-immutable-previewed-releases.md) | Proposed | Approval and publication bind to immutable release hashes |
