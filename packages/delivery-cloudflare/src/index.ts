...
const PUBLIC_ERROR_CODES: ReadonlySet<string> = new Set([
  ...
  "COOLIFY_APPLICATION_SCOPE_DENIED",
  "COOLIFY_COMMIT_INVALID",
  "COOLIFY_CONFIG_INVALID",
  "COOLIFY_OPERATION_INVALID",
  "COOLIFY_PROMOTION_INVALID",
  "COOLIFY_REFERENCE_INVALID",
  "COOLIFY_RESPONSE_INVALID",
  "COOLIFY_ROLLBACK_INVALID",
  "COOLIFY_TIMEOUT",
  "COOLIFY_TIMEOUT_INVALID",
  "COOLIFY_TOKEN_INVALID",
