...
export function renderAstroArtifact(input: AstroRenderInput): AstroArtifact {
  ...
  const files: Record<string, string> = {
    "package.json": canonical({ private: true, type: "module", packageManager: "pnpm@10.26.0", scripts: { build: "astro build", check: "astro check" }, dependencies: { astro: "7.2.4" }, devDependencies: { "@astrojs/check": "0.9.10", typescript: "5.9.3" } }),
